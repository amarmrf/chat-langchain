...
def create_chain(llm: LanguageModelLike, retriever: BaseRetriever) -> Runnable:
    ...
    response_synthesizer = (
        default_response_synthesizer.configurable_alternatives(
            ...
            openai_gpt_4o_mini=default_response_synthesizer,
            anthropic_claude_3_haiku=default_response_synthesizer,
            anthropic_claude_3_5_haiku=default_response_synthesizer,
...
claude_3_5_haiku = ChatAnthropic(
...
llm = gpt_3_5.configurable_alternatives(
    ...
    default_key="openai_gpt_3_5_turbo",
    openai_gpt_4o_mini=gpt_4o_mini,
    anthropic_claude_3_haiku=claude_3_haiku,
    anthropic_claude_3_5_haiku=claude_3_5_haiku,
    fireworks_mixtral=fireworks_mixtral,
    google_gemini_pro=gemini_pro,
    cohere_command=cohere_command,
).with_fallbacks(
    [gpt_3_5, gpt_4o_mini, claude_3_haiku, claude_3_5_haiku, fireworks_mixtral, gemini_pro, cohere_command]
)
